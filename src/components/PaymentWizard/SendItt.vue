<template>
    <div>
        ...
        <el-row>
            <label style='font-size:12px;font-weight:200'>Send <b>{{subscriptionAmount}} ITT</b><span style='color:lightslategray'> (${{Math.round(subscriptionAmount * this.itt_usd_rate)}})</span> to the following address.<br /> (Tap or scan the QR code below to copy the receiver address)</label>
        </el-row>
        <el-row>
